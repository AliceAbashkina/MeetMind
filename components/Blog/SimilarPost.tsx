...
export default function FeaturedPost(props: SimilarPostProps) {
    const { post } = props;
    ...
    return (
        ...
        >
            <Typography component='h1' sx={{ lineHeight: '50px', fontSize: '40px', fontWeight: '500', textAlign: 'left', color: '#4E4E4E', marginBottom: '50px' }}>Похожие статьи</Typography>
